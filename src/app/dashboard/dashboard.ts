...
export class Dashboard implements OnInit, AfterViewInit {
  ...
  onSubmit(): void {
    ...
    const url = `http://18.213.9.149:8082/api/v1/rides/search-with-fare?${params.toString()}`;
  ...
  onBook(): void {
    ...
    this.http.post('http://54.211.158.83:8083/api/v1/requests', payload).subscribe({
      next: (response) => {
